...
def main():
    ...
    st.subheader("A data-driven web app that visualizes various sentiment and exploratory analysis on tweets ")
    ...
    st.sidebar.subheader("Number of Tweets for Each column")
    ...
    if not st.sidebar.checkbox("Hide", True, key="4"):
        if each_airline == "Bar Plot":
            st.subheader("Number of Tweets for Each column")
